...
public class PopulationGenerator {
     ...
     * @return
     */
    public static List<IChromosome>  generatePopulation(int populationSize, TaskInfo taskInfo) {
     ...
     *
     * @param currMaxShiftsState map of valid number of occurrences of specific shift
     * @param shiftsNum          number of consecutive shifts
     * @param lastShift          last assigned shift
     * @return
     */
    private static List<Shift> getAllowedShifts(
