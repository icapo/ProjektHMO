...
public class TableChromosome implements IChromosome {
	...
	public Object getChromosomeElement(int row, int col, boolean verbose) {
		System.out.println("Returning element at ("+row+","+col+") = " + this.data[row][col]);
		return this.data[row][col];
	}
    ...
    public void setChromosomeElement(int row, int col, String value, boolean verbose) {
        System.out.println("Setting element at ("+row+","+col+") = " + value);
        this.data[row][col] = value;
    }
